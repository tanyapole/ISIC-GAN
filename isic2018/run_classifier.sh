...
# train_csv="/nfs/home/nduginets/gan-aug-analysis/splits/percentages/1_0/train_0.csv" epochs=100\
# val_root="/mnt/tank/scratch/nduginets"\
# val_csv="/nfs/home/nduginets/gan-aug-analysis/splits/isic2019-val.csv" model_name="inceptionv4"\
# exp_desc="Real" exp_name="gans.train_Real.inceptionv4.split0"